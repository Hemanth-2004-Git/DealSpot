...
const Profile = () => {
  ...
  const handleNameUpdate = async () => {
    ...
    try {
      ...
      // Refresh token to ensure Navbar gets updated user data
      if (refreshToken) {
        await refreshToken();
      }
                ...
                {isEditingName ? (
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl px-4 py-2 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 w-64 text-lg font-bold"
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="bg-white text-blue-600 px-4 py-2 rounded-xl font-semibold hover:bg-blue-50 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                      >
                        {updating ? (
                          <>
                      ...
                      <button
                        ...
                        disabled={updating}
                        className="bg-white/20 text-white px-4 py-2 rounded-xl font-semibold hover:bg-white/30 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="bg-white/20 backdrop-blur-sm hover:bg-white/30 border border-white/30 rounded-xl p-2 transition-colors duration-200 group"
                      title="Edit name"
                    >
              ...
              <div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mb-8">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-yellow-800">Security Best Practices</h3>
                      <div className="mt-2 text-yellow-700">
                        <p>• Always sign out when using shared devices<br/>• Use a strong, unique password<br/>• Enable two-factor authentication if available<br/>• Never share your login credentials</p>
                      </div>
                    </div>
                  </div>
                </div>
